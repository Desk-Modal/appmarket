...
def build_entry_single(
    ...
    return {
        ...
        "icon_url": f"https://raw.githubusercontent.com/Desk-Modal/appmarket/main/icons/{source['id']}.svg",
...
def build_entries_multi(
    ...
    for plugin in source["plugins"]:
        ...
        entries.append({
            ...
            "release_url": release.html_url,
            "changelog_url": f"https://github.com/{owner}/{repo}/releases",
            "icon_url": f"https://raw.githubusercontent.com/Desk-Modal/appmarket/main/icons/{plugin['id']}.svg",
