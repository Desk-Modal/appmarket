...
React 19 components, Jotai/Zustand state, Canvas 2D/WebGL rendering, DeskModal agent frame (TileContainer, overlays, palette), typed Tauri bridges, TradeSurface apps.
