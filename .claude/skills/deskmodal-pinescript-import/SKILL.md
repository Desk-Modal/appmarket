...
!`ROOT=$(bash "${CLAUDE_SKILL_DIR}/../_lib/dm-root.sh") && test -f "$ROOT/plugins/optiscript/specs/pinescript-compat-matrix.md" && head -20 "$ROOT/plugins/optiscript/specs/pinescript-compat-matrix.md"`
